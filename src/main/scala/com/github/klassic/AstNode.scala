...
object AstNode {
  ...
  case class ValDeclaration(val location: Location, variable: String, description: Option[TypeDescription], value: AstNode, immutable: Boolean = false) extends AstNode
