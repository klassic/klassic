...
case class TypeEnvironment(variables: Map[String, TypeScheme], immutableVariables: Set[String], records: Map[String, RecordConstructor], modules: Map[String, Map[String, TypeScheme]], parent: Option[TypeEnvironment]) {
  ...
  def updateRecord(recordName: String, recordBody: RecordConstructor): TypeEnvironment = {
