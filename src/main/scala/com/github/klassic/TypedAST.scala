...
object TypedAST {
  ...
  case class FunctionLiteral(val description: TypeDescription, val location: Location, params: List[FormalParameterOptional], optionalType: Option[TypeDescription], proc: TypedAST) extends TypedAST {
